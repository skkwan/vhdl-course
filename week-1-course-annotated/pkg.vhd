...
-- Point of pkg is to have the function nulll which initializes a data type
-- t_data, which consists of a reset bit, a valid bit, and a std_logic_vector
-- of length 8 (representing some float)
